...
<h1 className="text-3xl sm:text-4xl font-bold tracking-tight text-slate-800">Model Context Protocol Playground</h1>
...
{selectedCv && (
<span className="rounded-full bg-white/70 px-3 py-1 text-sm text-slate-700 border border-slate-200/70">Using CV: {selectedCv}</span>
)}
</div>
</header>
...
className="input"
/>
<button onClick={handleChat} disabled={chatLoading} className="btn btn-primary w-full sm:w-auto">
...
<footer className="mt-10 text-center text-sm text-slate-500">Built with Next.js  Secure by default</footer>
</main>
</div>
);
}
